...
export function NovoLimiteForm({ customers }: { customers: { id: string; name: string }[] }) {
  ...
  return (
    <form action={formAction} className="space-y-3">
      ...
      <button type="submit" disabled={pending || customers.length === 0} className="w-full rounded-lg bg-neutral-900 px-4 py-2 text-sm font-medium text-white hover:bg-neutral-800 disabled:opacity-50">
